![Status do Projeto](https://img.shields.io/badge/Status-Vers%C3%A3o%201.3%20Finalizada-brightgreen)
![Tecnologias](https://img.shields.io/badge/JS-Vanilla-yellow)
...
2. Abra o arquivo index.html em qualquer navegador moderno.
    Teste de Estresse (Debug) - Para validar o sistema de segurança da v1.3, você pode forçar um erro de memória no console (F12):
    try {
